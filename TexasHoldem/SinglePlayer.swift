...
/* View Mancanti:
 ...
 • Compilare le Rules -- √ FATTO
 • Un overlay per ricaricare il bankroll -- √ FATTO
 • Aggancio Game Center -- √ FATTO
 • Inserire i Suoni -- DA SELEZIONARE BENE -- √ FATTO
 
 • !!! Completare Algoritmo puntate !!!
 
 • Non funziona il limite x5 x3 flop e turn -- √ FATTO
 
 • Variare la vittoria in base al Pick e all'ALL in Preflop -- √ FATTO
 
 • Riposizionare DashBoard GameCenter -- √ FATTO
 • Inserire Achieviment -- √ FATTO
 • Creare avanzamento tavoli /chips -- √ FATTO
        ...
        ZStack {
           ...
           /* Image("logo")
            ...
            VStack {
                ...
                ButtonConsolleView(vm: vm, ga: ga, gl: gl)
